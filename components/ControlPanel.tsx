...
const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <div className="absolute top-8 bottom-8 left-8 w-[440px] z-[1100] flex flex-col pointer-events-none">
      <div
        className="glass-panel h-full rounded-[48px] overflow-hidden flex flex-col shadow-2xl pointer-events-auto border border-white/10 relative group"
        onMouseMove={(e) => {
